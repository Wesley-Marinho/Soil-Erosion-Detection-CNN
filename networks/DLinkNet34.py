...
class dilation_block(nn.Module):
    ...
    def forward(self, x):
        d1 = self.dropout(self.relu1(self.dilate1(x)))
        d2 = self.dropout(self.relu2(self.dilate2(d1)))
        d3 = self.dropout(self.relu3(self.dilate3(d2)))
        d4 = self.dropout(self.relu4(self.dilate4(d3)))
...
class DLinkNet34(nn.Module):
    def __init__(self, dropout_rate=0.5):
        ...
        self.dilation = dilation_block(512, dropout_rate)
